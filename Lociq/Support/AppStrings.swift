...
enum AppStrings {
    ...
    enum Labels {
        ...
        static let noSelectionBody = "Tap anywhere to load a neighborhood profile, compare ZIP and neighborhood views, and read the area at a glance."
        static let loadingSelectionTitle = "Loading area profile"
        static let loadingSelectionBody = "Loading neighborhood lines, local stats, and quick highlights for your selected location."
        static let dataZip = "Data: ZIP"
        static let dataTract = "Data: Neighborhood"
        ...
        static let mapInstructionTwo = "2. Switch between ZIP and neighborhood views at the top."
        static let mapInstructionThree = "3. Compare how the area and local context shift between the two views."
        static let collapsedHint = "Tap on map · swipe up for neighborhood profile"
        static let profileSubtitle = "Official local profile and quick highlights"
        ...
        static let geography = "Area"
        static let onboardingTitleOne = "Explore neighborhoods fast"
        static let onboardingBodyOne = "Tap any spot on the map to load local area details in seconds."
        static let onboardingTitleTwo = "Compare ZIP and Neighborhood"
        static let onboardingBodyTwo = "Switch views to see how stats shift between the broader ZIP and a closer neighborhood view."
        ...
        static let currentScale = "Current view"
        static let tractFallbackTitle = "ZIP fallback active"
        static let tractFallbackBody = "Neighborhood-level data is unavailable for this selection, so the profile is showing ZIP-level data instead."
        static let mapTipTitle = "Tap to explore"
        static let mapTipBody = "Select any point on the map to load a neighborhood profile, then switch between ZIP and neighborhood views."
